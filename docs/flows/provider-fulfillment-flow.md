...
Define how a paid PlacamIA order is handed off to the assigned manufacturing
provider and tracked through manufacturing, pickup, shipment, and delivery.
...
flowchart TD
    ...
    B2 --> B3[Send paid order to assigned provider]
...
- Provider acceptance happens after verified payment in the direct-checkout MVP
  path.
